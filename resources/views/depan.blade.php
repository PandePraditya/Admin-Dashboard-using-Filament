...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="{{ Storage::url($jumbotron->thumbnail) }}" alt="Avatar" />
            <!-- Masthead Heading-->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    @endif
                    @if ($linkedin)
                        <a class="btn btn-outline-light btn-social mx-1" href="{{ $linkedin }}"><i
                ...
                <!-- Footer About Text-->
                <div class="col-lg-4">
                    <h4 class="text-uppercase mb-4">About User</h4>
                    <p class="lead mb-0">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Partner Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="{{ Storage::url($item->thumbnail) }}" alt="Partner" />
                                    <!-- Partner Modal - Text-->
